 ...
 *EXTI_Line2(PA2)
 *This routine demonstrates that WFI enters the sleep mode, and the PA2 pin input
 *low level triggers the external interrupt EXTI_Line2 to exit the sleep mode,
