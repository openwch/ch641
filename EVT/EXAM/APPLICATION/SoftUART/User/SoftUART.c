 ...
 * @fn      TIM2_IRQHandler
 *
 * @brief   The function `TIM2_IRQHandler` handles the interrupt for the update event of TIM2 and performs
...
{
    // Configure the RCC used
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA | RCC_APB2Periph_TIM1 | RCC_APB2Periph_AFIO | RCC_APB2Periph_GPIOB, ENABLE);
    RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM2, ENABLE);
    RCC_AHBPeriphClockCmd(RCC_AHBPeriph_DMA1, ENABLE);
