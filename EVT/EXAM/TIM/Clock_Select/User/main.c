 ...
 *External clock source mode 1: PB2 is used as clock input pin,
 *External clock source mode 2: PB9 is used as clock input pin.
 *
 */
...
void TIM1_ETRClockMode1_Init(void)
{
    ...
    /* GPIOB2 Input as TIM Clock Source */
