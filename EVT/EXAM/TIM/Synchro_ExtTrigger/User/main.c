 ...
 *Slave mode routine:
 *TIM1_CH1(PB2)
 *This example demonstrates that when the TIM_CH1(PB2) need pull-down external resistance input pin detects a rising edge,
 *TIM1 works differently in different slave modes.
 *RESET_MODE - TIM1->CNT reset and recount
 *GATED_MODE - PB2 pin input low level, TIM1->CNT counts normally, otherwise stop counting.
