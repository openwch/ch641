 ...
 *ADC channel 2 (PA8) - rule group channel, external trigger pin (PA4) high level
 *triggers EXTI line 4 event,In this mode, an ADC conversion is triggered by an
 *event on the EXTI line 4, and an EOC interrupt is generated after the conversion
 *is completed.
 *
*/
...
void ADC_Function_Init(void)
{
    ...
    ADC_InitStructure.ADC_ExternalTrigConv = ADC_ExternalTrigConv_Ext_PA4_PA15;
