 ...
 *ADC channel 2 (PA8) - injection group channel, channel 3 (PA10) - injection group channel,
 *channel 11 (PA13) - injection group channel, this mode Next, an ADC conversion is triggered
...
void ADC_Function_Init(void)
{
    ...
    ADC_InjectedChannelConfig(ADC1, ADC_Channel_6, 3, ADC_SampleTime_241Cycles);
