...
/*
 *@Note
 *PEC error check, slave mode transceiver routine:
 *I2C1_SCL(PA13)\I2C1_SDA(PA14).
 *This example demonstrates that the Slave receives. If a transmission error occurs, an error interrupt is triggered.
