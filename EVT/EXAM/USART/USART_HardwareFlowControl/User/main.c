 ...
 *@Note
 ...
 USART1_Tx(PA11)\USART1_Rx(PA12)\USART1_CTS(PA13)\USART1_RTS(PA14)
...
void USART1_ReCFG(void)
{
    ...
    /* USART1 TX-->A.11   RX-->A.12 */
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_11;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_30MHz;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;
    GPIO_Init(GPIOA, &GPIO_InitStructure);
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_14; /* RTS-->A.14*/
    GPIO_Init(GPIOA, &GPIO_InitStructure);

    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
    GPIO_Init(GPIOA, &GPIO_InitStructure);
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13; /* CTS-->A.13 */
    GPIO_Init(GPIOA, &GPIO_InitStructure);
